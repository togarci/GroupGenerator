...
const elementoHTML = "<div id='toasted-container' style='position: fixed; display: flex; justify-content: center; width: 100%; top: 0px;'> <div id='toasted'><img src='./assests/times-solid-black.svg' style='width:10px'> </div> </div>";
